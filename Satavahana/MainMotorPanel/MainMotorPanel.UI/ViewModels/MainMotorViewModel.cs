...
{
    public class MainMotorViewModel : BindableBase
    {
        ...
        public MainMotorViewModel(IRegionManager regionManager, IFieldDevicesCommunicator fieldDevicesCommunicator)
        {
