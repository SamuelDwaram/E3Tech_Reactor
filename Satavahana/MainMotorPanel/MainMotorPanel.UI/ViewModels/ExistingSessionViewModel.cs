...
namespace MainMotorPanel.UI.ViewModels
{
    public class ExistingSessionViewModel : BindableBase
    {
        ...
        public ExistingSessionViewModel(IUnityContainer unityContainer, IRegionManager regionManager, IReportPrinter reportPrinter, IDatabaseReader databaseReader)
        {
        ...
        private void DownloadReport(object id)
        {
            ...
            reportPrinter.PrintReportSections("MAIN MOTOR REPORT", new List<ReportSection> {
        ...
        {
            get => _deviceId ?? (_deviceId = "Motor_1");
