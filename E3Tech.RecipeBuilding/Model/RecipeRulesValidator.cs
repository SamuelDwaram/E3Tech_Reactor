    ...
    public class RecipeRulesValidator : IRecipeRulesValidator
    {
        ...
        public bool ValidateAddingNewBlockToStep(RecipeStep recipeStep, IRecipeBlock block, int blockIndex)
        {
            if (recipeStep.BlockFour == null
                        && recipeStep.BlockOne == null
                        && recipeStep.BlockTwo == null
                        && recipeStep.BlockThree == null)
            {
                return true;
            }
            ...
            switch (blockIndex)
            {
                ...
                case 1:
                    // prevent adding new block to before filling previous block.
                    return recipeStep.BlockTwo == null && recipeStep.BlockOne != null;
                case 2:
                    // prevent adding new block to before filling previous blocks.
                    return recipeStep.BlockThree == null
                        && recipeStep.BlockOne != null
                        && recipeStep.BlockTwo != null;
                case 3:
                    // prevent adding new block to before filling previous blocks.
                    return recipeStep.BlockFour == null
                        && recipeStep.BlockOne != null
                        && recipeStep.BlockTwo != null
                        && recipeStep.BlockThree != null;
                default:
        ...
        private bool CheckIfBlockExistInStep(RecipeStep recipeStep, IRecipeBlock block)
        {
            ...
            return recipeStep.BlockOne?.Name != block.Name &&
                recipeStep.BlockTwo?.Name != block.Name &&
                recipeStep.BlockThree?.Name != block.Name &&
                recipeStep.BlockFour?.Name != block.Name;
        }
