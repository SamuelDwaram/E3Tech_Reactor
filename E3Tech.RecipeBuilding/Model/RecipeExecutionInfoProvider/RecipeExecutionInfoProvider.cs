...
namespace E3Tech.RecipeBuilding.Model.RecipeExecutionInfoProvider
{
    public class RecipeExecutionInfoProvider : IRecipeExecutionInfoProvider
    {
        ...
        public void SaveRecipeExecutionInfo(IList<RecipeStep> recipeSteps, string deviceId)
        {
            ...
            {
                if (step.BlockOne != null) AddRecipeBlockExecutionInfo(step.BlockOne, deviceId);
                if (step.BlockTwo != null) AddRecipeBlockExecutionInfo(step.BlockTwo, deviceId);
                if (step.BlockThree != null) AddRecipeBlockExecutionInfo(step.BlockThree, deviceId);
                if (step.BlockFour != null) AddRecipeBlockExecutionInfo(step.BlockFour, deviceId);
            }
        }
